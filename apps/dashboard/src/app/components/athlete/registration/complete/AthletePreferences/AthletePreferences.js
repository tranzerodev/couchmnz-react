...
import {REGISTRATION_ATHLETE_ACCOUNT, REGISTRATION_ATHLETE_PROFILE} from '../../../../../constants/pathConstants';
...
class Preferences extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (this.props.profile.status === PENDING &&
      ...
      if (nextProps.preferences.status !== FULFILLED && nextProps.preferences.status !== PENDING && nextProps.profile.status !== REJECTED && isNonEmptyArray(nextProps.profile.data.sports)) {
        ...
        this.props.fetchAthletePreferences({athleteId: nextProps.profile.data.id, sportId});
  ...
  componentDidMount() {
    ...
    if (preferences.status !== FULFILLED && preferences.status !== PENDING && profile.status !== REJECTED && isNonEmptyArray(profile.data.sports)) {
      ...
      this.props.fetchAthletePreferences({athleteId: profile.data.id, sportId});
      this.props.fetchTrainingList(sportId);
    }
  }
  submitForm() {
            ...
            <div className="uk-container-fluid uk-container-center">
              <div className="uk-grid">
                <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1">
                  <PreviousLink history={this.props.history} previous={REGISTRATION_ATHLETE_PROFILE}/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="uk-container uk-container-center">
                    ...
                    <div className="uk-grid uk-grid-mobile">
                      <div className="uk-width-xlarge-3-10 uk-width-large-3-10 uk-width-medium-1-2  uk-width-small-1-1 uk-width-mobile">
                        <div className={validation.experience === false && submitted ? appConstants.fieldClasses.error : appConstants.fieldClasses.holder}>
                          ...
                          <input type="text" name className="uk-form-controls" placeholder={t('AthletePreferences.enterYears')} value={notNull(yearOfExperience) ? yearOfExperience : ''} onChange={this.handleExperience} min={0}/>
                    ...
                    <div className="uk-grid uk-grid-mobile">
                      <div className="uk-width-xlarge-6-10 uk-width-large-6-10 uk-width-medium-1-1  uk-width-small-1-1 uk-width-mobile">
                        <div className="field-holder">
                          ...
                          <textarea className="uk-form-controls uk-form-date" placeholder={t('AthletePreferences.notesExample')} value={notNull(notes) ? notes : ''} onChange={this.handleNotes}/>
            ...
            <div className="uk-grid">
              <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 uk-text-right">
                <NextLink history={this.props.history} submitForm={this.submitForm} saveData={this.props.saveAthletePreferences} data={data} saveType={appConstants.saveType.sportsSpecific} next={REGISTRATION_ATHLETE_ACCOUNT} buttonText={t('NextLink.next')}/>
              </div>
            </div>
          </div>
        </section>
...
const AthletePreferences = connect(mapStateToProps, mapDispatchToProps)(Preferences);
export default translate(AthletePreferences);
