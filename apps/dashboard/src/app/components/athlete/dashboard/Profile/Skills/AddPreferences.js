...
import {fetchSportsList, fetchSkillsList, fetchTrainingList, saveAthletePreferences, fetchAthletePreferences} from '../../../../../actions';
import validatePreferences from '../../../../../validators/athlete/common/preferences';
...
class AddPreferences extends Component {
  ...
  submitForm() {
    ...
    const isExistingSport = profile.status === FULFILLED ? profile.data.sports.findIndex(s => s.id === sport.id) >= 0 : false;
    this.setState({
      submitted: true,
      validation
    });
    return validation.valid && !isExistingSport;
  }
  ...
  handleSkillLevel(e) {
    ...
    const skillLevel = index >= 0 ? skillsList.data[index] : {id: null, description: null};
  ...
  render() {
    ...
    const data = {id, name, specializations, yearOfExperience, skillLevel, notes, preferences: {...preferences, travelPref: {...travelPref, distance: travelPref.unit === appConstants.units.distance.kilometres ? kilometresToMiles(travelPref.distance) : travelPref.distance, unit: appConstants.units.distance.miles}}, athleteId: profile.data.id, sportId: sport.id};
    const validation = validatePreferences(sport);
    const isExistingSport = profile.status === FULFILLED && isNonEmptyArray(profile.data.sports) ? profile.data.sports.findIndex(s => s.id === sport.id) >= 0 : false;
    const invalidSport = (submitted && validation.sport === false) || isExistingSport;
    return (
          ...
          <div className="uk-grid">
            <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 ">
              <section className="stepSection stepSectionNxt cl-sm-athleteSection ssp-regflow-1o">
                <div className="uk-grid">
                  <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 ">
                    <h1 className="uk-text-left">{t('AthletePreferences.' + (isSportSet ? 'editTitle' : 'addTitle'))}</h1>
                    ...
                    <div className="buildProfile buildProfileSec">
                      <div className="customDropdown">
                          ...
                          <div className="uk-width-xlarge-4-10 uk-width-large-4-10 uk-width-medium-1-2  uk-width-small-1-1 uk-width-mobile">
                            <div className="uk-form-inline uk-from-inline-mobile">
                              <div className={invalidSport ? appConstants.fieldClasses.error : appConstants.fieldClasses.holder}>
                                ...
                                <span className="error-text">{invalidSport && isExistingSport && t('InputSport.validation_messages.sportsName.existing')}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="uk-grid uk-grid-mobile">
                          <div className="uk-width-xlarge-4-10 uk-width-large-4-10 uk-width-medium-1-2  uk-width-small-1-1 uk-width-mobile">
                            <div className={validation.experience === false && submitted ? appConstants.fieldClasses.error : appConstants.fieldClasses.holder}>
                              ...
                              <input type="text" name className="uk-form-controls" placeholder={t('AthletePreferences.enterYears')} value={yearOfExperience ? yearOfExperience : ''} onChange={this.handleExperience}/>
                          ...
                          <div className="uk-width-xlarge-4-10 uk-width-large-4-10 uk-width-medium-1-2 uk-width-small-1-1 uk-width-mobile">
                            <div className={validation.skillLevel === false && submitted ? appConstants.fieldClasses.error : appConstants.fieldClasses.holder}>
                              ...
                              <select className="uk-form-controls field-required" value={skillLevel && skillLevel.id ? skillLevel.id : ''} name={skillLevel.description} onChange={this.handleSkillLevel}>
                        ...
                        <div className="uk-grid uk-grid-mobile">
                          <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 uk-width-mobile">
                            <div className="field-holder">
                              <label>{t('AthletePreferences.validation_messages.notes')}</label>
                              <textarea className="uk-form-controls uk-form-date" placeholder={t('AthletePreferences.notesExample')} value={notes ? notes : ''} onChange={this.handleNotes}/>
                              <span className="error-text">{t('AthletePreferences.validation_messages.notes')}</span>
                            </div>
                          </div>
                        </div>
                              ...
                              <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 uk-width-mobile">
                                <div className="uk-form-inline uk-from-inline-mobile">
                                  <div className={validation.sspSubTypes === false && submitted ? appConstants.fieldClasses.error : appConstants.fieldClasses.holder}>
                                    <h6 className="uk-padding-remove">{t('AthletePreferences.trainingPref')}</h6>
                                    <div className="tandc instructioncheck">
                                      ...
                                      <label htmlFor="trainingAll">{t('AthletePreferences.all')}</label>
                                      {
                                      ...
                                      <span className="error-text">{t('AthletePreferences.validation_messages.sspSubTypes')}</span>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 cl-sm-tandc">
                                <div className="chk-sec">
                                  <div className="field-holder">
                                    ...
                                    <label className="chechkShow" htmlFor="level31">{t('AthletePreferences.otherTypes')}</label>
                                    ...
                                    <div className="after-check-sec" style={{display: showOtherTypes ? appConstants.displayTypes.block : appConstants.displayTypes.none}}>
                                      <p>{t('AthletePreferences.otherTypesExample')} </p>
                                      <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 uk-width-mobile">
                                        <div className="field-holder">
                          ...
                          <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 uk-width-mobile">
                            <div className="uk-form-inline uk-from-inline-mobile">
                              <div className={validation.trainerGenders === false && submitted ? appConstants.fieldClasses.error : appConstants.fieldClasses.holder}>
                                <h6 className="uk-padding-remove">{t('AthletePreferences.serviceProvider')}</h6>
                                <div className="tandc instructioncheck">
                                  ...
                                  <label htmlFor="spr1">{t('AthletePreferences.genders.A')}</label>
                                  ...
                                  <label htmlFor="spr2">{t('AthletePreferences.genders.M')}</label>
                                  ...
                                  <label htmlFor="spr3">{t('AthletePreferences.genders.F')}</label>
                                  <span className="error-text">{t('AthletePreferences.validation_messages.gender')}</span>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="uk-grid uk-grid-mobile num60">
                          <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 ">
                            <label>{t('AthletePreferences.travelPref')}</label>
                          </div>
                          <div className="uk-width-xlarge-3-10 uk-width-large-3-10 uk-width-medium-1-2  uk-width-small-1-1 uk-width-mobile">
                            <div className={validation.distance === false && submitted ? appConstants.fieldClasses.error : appConstants.fieldClasses.holder}>
                              <input type="number" min={0} name placeholder={t('AthletePreferences.howFar')} value={distance ? distance : ''} onChange={this.handleDistance}/>
                              <select className="uk-form-controls uk-form-width-small addon" placeholder value={unit ? unit : ''} onChange={this.handleDistanceUnit}>
                                <option value={appConstants.units.distance.miles}>{t('AthletePreferences.distanceUnits.M')}</option>
                                <option value={appConstants.units.distance.kilometres}>{t('AthletePreferences.distanceUnits.K')}</option>
                              </select>
                              <span className="error-text">{t('AthletePreferences.validation_messages.travelPref')}</span>
                            </div>
                          </div>
                          <div className="uk-width-xlarge-5-10 uk-width-large-5-10 uk-width-medium-1-2  uk-width-small-1-1 uk-width-mobile">
                            <div className={validation.address === false && submitted ? appConstants.fieldClasses.error : appConstants.fieldClasses.holder}>
                              <input type="text" name placeholder={t('AthletePreferences.address')} onChange={this.handleAddress} value={travelFrom && travelFrom.address ? travelFrom.address : ''}/>
                              <span className="error-text">{t('AthletePreferences.validation_messages.address')}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="uk-grid">
                  <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 uk-text-right">
                    <NextLink history={this.props.history} submitForm={this.submitForm} saveData={this.props.saveAthletePreferences} data={data} saveType={appConstants.saveType.sportsSpecific} buttonText={t('NextLink.save')} onSave={this.props.onSave}/>
                  </div>
                </div>
              </section>
            </div>
  ...
  static get propTypes() {
    return {
      ...
      saveAthletePreferences: PropTypes.func.isRequired,
...
const mapStateToProps = state => {
  const {sportsList, skillsList, trainingList, servicesList, athlete, profile} = state;
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    saveAthletePreferences: (data, updateType) => dispatch(saveAthletePreferences(data, updateType)),
    fetchAthletePreferences: params => dispatch(fetchAthletePreferences(params))
  };
};

const Preferences = connect(mapStateToProps, mapDispatchToProps)(AddPreferences);
