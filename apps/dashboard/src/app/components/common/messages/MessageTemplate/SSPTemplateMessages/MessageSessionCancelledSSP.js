...
class MessageSessionCancelledSSP extends PureComponent {
  render() {
    ...
    return (
      ...
      <div className="msg_messagesDetail-messageContent">
        ...
        <div className="msg_messagesDetail-messageSimple msg_messagesDetail-messageSimpleSec">
          ...
          <p>{p.t(reason ? 'sessionCancelDetails' : 'sessionCancel', {dateTime, sport: body.sportName, ...session})}</p>
...
MessageSessionCancelledSSP.defaultProps = {

};

MessageSessionCancelledSSP.propTypes = {
  name: PropTypes.string.isRequired,
  message: PropTypes.object.isRequired,
  p: PropTypes.shape({t: PropTypes.func.isRequired}).isRequired
};
export default translate('MessageSessionCancelledSSP')(MessageSessionCancelledSSP);
