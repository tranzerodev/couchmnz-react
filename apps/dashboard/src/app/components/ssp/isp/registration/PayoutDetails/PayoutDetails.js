...
import {REGISTRATION_ISP_PAYPAL_SETTINGS, REGISTRATION_ISP_BANK_PAYOUT, WELCOME} from '../../../../../constants/pathConstants';
...
class PayoutDetails extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      payoutOption: this.props.payoutOption
    };
  }
  componentDidMount() {
    window.scrollTo(0, 0);
  ...
  render() {
    const {payoutOption, currency} = this.state;
    return (
      <section className="stepSection stepSectionNxt ssp-regflow-1o">
        <div className="uk-container uk-container-center">
          <div className="uk-grid">
            <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 ">
              <h1 className="uk-padding-remove">{this.props.p.t('PayoutDetails.title')}</h1>
              <p>{this.props.p.t('PayoutDetails.message')}</p>
            </div>
          </div>
          <div className="uk-grid">
            <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 ">
              <div className="accDetails">
                <div className="uk-grid">
                  <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1">
                    <label>{this.props.p.t('PayoutDetails.currency')}</label>
                  </div>
                  <div className="uk-width-xlarge-1-3 uk-width-large-1-3 uk-width-medium-1-2  uk-width-small-1-1">
                    <div className="field-holder">
                      <select className="uk-form-controls" value={currency ? currency : null} onChange={this.handleCurrency}>
                      ...
                      <span className="error-text">{this.props.p.t('PayoutDetails.validation_messages.currency')}</span>
                    </div>
                  </div>
                </div>
                <div className="uk-grid">
                  <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1">
                    <h6>{this.props.p.t('PayoutDetails.selectPayout')}</h6>
                    <div className="tandc">
                      <input id="payoption1" type="radio" checked={payoutOption === appConstants.payoutOption.payPal} value={appConstants.payoutOption.payPal} onChange={this.handlePayout}/>
                      <label htmlFor="payoption1">
                        <svg className="cl-icon-paypal" xmlns="http://www.w3.org/2000/svg" viewBox="9161 -1878.5 94 59">
                          <g data-name="Group 291" transform="translate(8749 -2381.5)">
                            <rect id="Rectangle_185" data-name="Rectangle 185" className="cl-icon-paypal-1" width={93} height={58} rx={5} transform="translate(412.5 503.5)"/>
                    ...
                    <div className="tandc">
                      <input id="payoption2" type="radio" checked={payoutOption === appConstants.payoutOption.bank} value={appConstants.payoutOption.bank} onChange={this.handlePayout}/>
                      <label htmlFor="payoption2">
                        <svg className="cl-icon-bank" xmlns="http://www.w3.org/2000/svg" viewBox="9162 -1786 92.5 57.5">
                          <g id="Group_294" data-name="Group 294" transform="translate(8764 -2364)">
                            <g id="Rectangle" transform="translate(398 577.5)">
                              <rect id="Rectangle_183" data-name="Rectangle 183" className="cl-icon-bank-1" width="92.5" height="57.5" rx="5" transform="translate(0 0.5)"/>
                              <rect id="Rectangle_184" data-name="Rectangle 184" className="cl-icon-bank-2" width="91.283" height="56.302" rx="5" transform="translate(0.609 1.099)"/>
                            </g>
                            <g id="Group_293" data-name="Group 293" transform="translate(0 2)">
                              <text id="BANK" className="cl-icon-bank-3" transform="translate(417 607)"><tspan x="0" y="0">{this.props.p.t('PayoutDetails.bank_cap')}</tspan></text>
                              <g id="Group_292" data-name="Group 292">
                                <text id="_321186345" data-name="321186345" className="cl-icon-bank-4" transform="translate(407 617)"><tspan x="0" y="0">{this.props.p.t('PayoutDetails.account_number')}</tspan></text>
                                <text id="_74218447" data-name="74218447" className="cl-icon-bank-4" transform="translate(456 617)"><tspan x="0" y="0">{this.props.p.t('PayoutDetails.routing_number')}</tspan></text>
                              </g>
                            </g>
                          </g>
                        </svg>
            ...
            <div className="uk-width-xlarge-1-4 uk-width-large-1-4 uk-width-medium-1-3  uk-width-small-1-2">
              <div className="nxtAlign">
                <NextLink
                  ...
                  next={this.props.payoutOption ?
                    this.props.payoutOption === appConstants.payoutOption.payPal ?
                      REGISTRATION_ISP_PAYPAL_SETTINGS : REGISTRATION_ISP_BANK_PAYOUT : WELCOME}
                />
              </div>
            </div>
...
const mapStateToProps = state => {
  const {payoutOption, currency} = state;
  return {
    payoutOption,
    currency
  };
...
const Registration13 = connect(mapStateToProps, mapDispatchToProps)(PayoutDetails);
export default translate(Registration13);
