...
class ProfilePictureClass extends React.PureComponent {
  ...
  */
  ...
  render() {
    const isProfilePicture = Boolean(this.props.displayPicture && this.props.displayPicture.picture);
    ...
    return (
      <div>
        <div className={uploadDivClassName}>
          <div className="uk-grid">
            <div className="uk-width-xlarge-1-3 uk-width-large-1-3 uk-width-medium-1-3  uk-width-small-1-1 ">
              ...
              { isProfilePicture ?
                <div className="uploadedProfilePhoto">
                  <img src={this.props.displayPicture.picture + '?date=' + (new Date())}/>
                </div> :
              ...
              <div className="uploadPhoto">
                <a onClick={this.handleTriggerProfilePictureFileUpload}>
                  {isProfilePicture ? this.props.p.t('ProfilePicture.change') + ' ' : this.props.p.t('ProfilePicture.upload') + ' '}
            ...
            <div className="uk-width-xlarge-2-3 uk-width-large-2-3 uk-width-medium-2-3  uk-width-small-1-1">
              <div className={this.props.sspValidation.media.profilePicture === false && this.props.sspValidation.media.submitted ? 'field-holder error' : 'field-holder'}>

                <div className="photoDes">
                  <p>{this.props.p.t('ProfilePicture.message1')}  {appConstants.profilePicture.dimensions.height} x {appConstants.profilePicture.dimensions.width}px. {this.props.p.t('ProfilePicture.message2')}</p>
                  <a/>
                </div>

                <span className="error-text">Please upload a profile photo </span>
              </div>
            </div>
            <div className="uk-width-xlarge-1-4 uk-width-large-1-4 uk-width-medium-1-1  uk-width-small-1-1 ">
              <div id="my-id2" className="uk-offcanvas">
        ...
        <div className="imageSpecification" style={{display: this.state.save}}>
          <a className="cross holder-cross" value={'picture'} onClick={this.handleClose}/>
          <div className="uk-grid">
