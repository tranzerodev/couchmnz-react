...
class DashboardAccountDeactivate extends PureComponent {
  constructor(props) {
    super(props);
...
DashboardAccountDeactivate.defaultProps = {

};

DashboardAccountDeactivate.propTypes = {
...
export default translate(connect(mapStatetoProps, mapDispatchToProps)(DashboardAccountDeactivate));
