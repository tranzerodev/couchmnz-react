...
import validateProfile from '../../../../../validators/parent/common/profileShort';
import {FULFILLED, PENDING} from '../../../../../constants/ActionTypes';
import {saveParentShortProfile, fetchSportsList, fetchSkillsList, fetchTrainingList, fetchParentPreferences} from '../../../../../actions';
...
class Profile extends Component {
  ...
  renderFirstName() {
    ...
    const {profile, submitted, sport} = this.state;
  ...
  renderExperience() {
    ...
    return (
      <div className={validation.experience === false && submitted ? 'field-holder error' : 'field-holder'}>
        ...
        <input type="number" name className="uk-form-controls field-required" placeholder={t('ParentPreferences.enterYears')} value={yearOfExperience} onChange={this.handleExperience}/>
  ...
  render() {
    ...
    return (
      <div className>
        ...
        {/* end back SECTION */}
        {/* START STEP SECTION */}
        <section className="stepSection stepSectionNxt cl-sm-parentSection ssp-regflow-1o">
          <div className="uk-container uk-container-center">
            <div className="uk-grid">
              <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 ">
                <h1 className="uk-text-left uk-padding-remove">{t('Welcome.build_your_profile')}</h1>
                <p className>{t('ParentProfile.message')}</p>
              </div>
            </div>
            <div className="uk-grid">
              <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 ">
            ...
            <div className="uk-grid">
              <div className="uk-width-xlarge-1-1 uk-width-large-1-1 uk-width-medium-1-1  uk-width-small-1-1 uk-text-right">
                <NextLink history={this.props.history} submitForm={this.submitForm} saveData={this.props.saveParentShortProfile} data={data} saveType={appConstants.saveType.profile} next={DASHBOARD} buttonText={t('NextLink.next')}/>
              </div>
            </div>
          </div>
        </section>
  ...
  static get propTypes() {
    return {
      ...
      saveParentShortProfile: PropTypes.func.isRequired,
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    saveParentShortProfile: params => dispatch(saveParentShortProfile(params))
  };
};
