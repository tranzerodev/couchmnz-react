import {PENDING, FULFILLED, REJECTED, FETCH_PARENT_PROFILE, FETCH_PARENT_PREFERENCES} from '../../../constants/ActionTypes';
...
export default function sportsMapping(state = initialState, action) {
  switch (action.type) {
    case FETCH_PARENT_PROFILE + PENDING: return Object.assign({}, state, {status: PENDING});
    ...
    case FETCH_PARENT_PROFILE + REJECTED: return Object.assign({}, state, {status: REJECTED});
