import {UPDATE_SKILLLEVEL, CLEAR_SKILLLEVELS, ADD_SKILLLEVEL, SET_SKILLS, SAVE_TRINING_PREFERENCES, CLEAR_SPORTS_RELATED_STORES} from '../../../../constants/ActionTypes';
...
export default function skills(state = initialState, action) {
  switch (action.type) {
    ...
    case SAVE_TRINING_PREFERENCES: {
      const {skillLevels} = action;
      return Object.assign([], skillLevels);
    }
