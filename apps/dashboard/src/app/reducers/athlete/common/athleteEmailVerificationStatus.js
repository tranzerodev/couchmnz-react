import {FULFILLED, REJECTED, PENDING, ATHLETE_VERIFY_EMAIL_OTP, ATHLETE_VERIFY_EMAIL} from '../../../constants/ActionTypes';
...
export default function emailVerification(state = initialState, action) {
  switch (action.type) {
    case ATHLETE_VERIFY_EMAIL_OTP + FULFILLED: {
    ...
    case ATHLETE_VERIFY_EMAIL_OTP + PENDING: return Object.assign({}, state, {status: PENDING});
    case ATHLETE_VERIFY_EMAIL_OTP + REJECTED: return Object.assign({}, state, {status: REJECTED});
    case ATHLETE_VERIFY_EMAIL + FULFILLED: {
      const {responseCode} = action.payload.data;
    ...
    case ATHLETE_VERIFY_EMAIL + PENDING: return Object.assign({}, state, {verifyEmailstatus: PENDING});
    case ATHLETE_VERIFY_EMAIL + REJECTED: return Object.assign({}, state, {verificationStatusCode: null, verifyEmailstatus: REJECTED});
    default:
      return state;
  }
}
