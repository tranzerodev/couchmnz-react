import {FETCH_ORDER_DETAILS, FULFILLED, PENDING, REJECTED} from '../../../constants/ActionTypes';
...
export default function orderDetails(state = initialState, action) {
  switch (action.type) {
    case FETCH_ORDER_DETAILS + FULFILLED: {
      let orderDetails = {};
    ...
    case FETCH_ORDER_DETAILS + PENDING: {
      return {data: {}, status: PENDING};
    }
    case FETCH_ORDER_DETAILS + REJECTED: {
